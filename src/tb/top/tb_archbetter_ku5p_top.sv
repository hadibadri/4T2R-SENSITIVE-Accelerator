...
module tb_archbetter_ku5p_top;
    ...
    initial begin : main
        ...
        cfg_w(A_IMEM_LO, nop_w[31:0]);  cfg_w(A_IMEM_HI, nop_w[63:32]);
        cfg_w(A_IMEM_LO, eop_w[31:0]);  cfg_w(A_IMEM_HI, eop_w[63:32]);
        cfg_w(A_CTRL, 32'h1);
